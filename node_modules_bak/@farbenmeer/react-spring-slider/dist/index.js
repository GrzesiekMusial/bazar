...
var Slider = function (_a) {
    var _b = _a.activeIndex, activeIndex = _b === void 0 ? 0 : _b, ArrowComponent = _a.ArrowComponent, _c = _a.arrowStyle, arrowStyle = _c === void 0 ? {} : _c, _d = _a.auto, auto = _d === void 0 ? 0 : _d, BulletComponent = _a.BulletComponent, _e = _a.bulletStyle, bulletStyle = _e === void 0 ? {} : _e, _f = _a.children, children = _f === void 0 ? [] : _f, _g = _a.hasArrows, hasArrows = _g === void 0 ? false : _g, _h = _a.hasBullets, hasBullets = _h === void 0 ? false : _h, _j = _a.onSlideChange, onSlideChange = _j === void 0 ? function () { return undefined; } : _j, _k = _a.setSlideCustom, setSlideCustom = _k === void 0 ? undefined : _k, _l = _a.slidesAtOnce, slidesAtOnce = _l === void 0 ? 1 : _l;
    var sliderRef = react_1.useRef(null);
    var _m = react_1.useState(0), slide = _m[0], setSlideOriginal = _m[1];
    var setSlide = setSlideCustom
        ? function (index) { return setSlideOriginal(setSlideCustom(index)); }
        : setSlideOriginal;
    var _o = react_1.useState(false), isDragging = _o[0], setDragging = _o[1];
    // Initialize slides with spring
    var _p = react_spring_1.useSprings(children.length, function (index) { return ({
        offset: index,
    }); }), springProps = _p[0], setSpringProps = _p[1];
    ...
    var bullets = function () {
        var arr = [];
        for (var index = 0; index <= children.length - slidesAtOnce; index++) {
            arr.push(react_1.default.createElement(bullet_1.default, { key: index, index: index, BulletComponent: BulletComponent, setSlide: setSlide, activeIndex: slide, bulletStyle: bulletStyle }));
        }
        return arr;
    };
        ...
        react_1.default.createElement(StyledSlider, null,
            ...
            springProps.map(function (_a, index) {
                ...
                return (react_1.default.createElement(react_spring_1.animated.div, __assign({}, gestureBinds(), { key: index, className: "slider__slide", style: {
                        transform: offset.interpolate(function (offsetX) { return "translate3d(" + offsetX * 100 + "%, 0, 0)"; }),
                        position: "absolute",
